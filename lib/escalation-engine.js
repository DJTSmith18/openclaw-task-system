...
class EscalationEngine {
  ...
  async immediateBlockedEscalation(taskId, agentId, reason) {
    ...
    if (supervisor === 'human') {
      ...
      if (schedulerAgentId && this.runtime?.system?.runCommandWithTimeout) {
        ...
        this.log.error(`[task-system/escalation] cannot wake scheduler — runtime: ${!!this.runtime?.system?.runCommandWithTimeout}, schedulerAgentId: ${schedulerAgentId || 'NOT SET'}`);
      }
