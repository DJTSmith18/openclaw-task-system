...
const DEFAULTS = {
  ...
  nudge: { enabled: true, nudge_in_progress_minutes: 20, nudge_in_progress_interval_minutes: 15, nudge_blocked_minutes: 15, nudge_blocked_interval_minutes: 15, nudge_unstarted_minutes: 10, nudge_unstarted_interval_minutes: 10, max_nudges: 5 },
...
const VALIDATORS = {
  ...
  nudge: { enabled: 'boolean', nudge_in_progress_minutes: 'posint', nudge_in_progress_interval_minutes: 'posint', nudge_blocked_minutes: 'posint', nudge_blocked_interval_minutes: 'posint', nudge_unstarted_minutes: 'posint', nudge_unstarted_interval_minutes: 'posint', max_nudges: 'posint' },
